var textos_ES = {
	...
	'text_titulo_app': 'Interfaz IU ET2 ',
	'text_titulo_menu': 'Opciones de Menu',
	'text_titulo_pie': 'Pie de página',
    'label_seleccioncolumnas': 'Seleccione las columnas',
    ...
    */
    ...
    'text_contenido_titulo_form_alumnograduacion_ADD': 'Formulario ADD de datos alumnograduacion',
	'text_contenido_titulo_form_alumnograduacion_EDIT': 'Formulario EDIT de datos alumnograduacion',
	'text_contenido_titulo_form_alumnograduacion_DELETE': 'Formulario DELETE de datos alumnograduacion',
	'text_contenido_titulo_form_alumnograduacion_SHOWCURRENT': 'Formulario SHOWCURRENT de datos alumnograduacion',
    'text_contenido_titulo_form_alumnograduacion_SEARCH': 'Formulario SEARCH de datos alumnograduacion',

	//textos entidad articulo
	'text_titulo_page_articulo' : 'Gestión de datos Artículo',
	'text_contenido_titulo_form_articulo_ADD': 'Formulario ADD de datos Artículo',
	'text_contenido_titulo_form_articulo_EDIT': 'Formulario EDIT de datos Artículo',
	'text_contenido_titulo_form_articulo_DELETE': 'Formulario DELETE de datos Artículo',
	'text_contenido_titulo_form_articulo_SHOWCURRENT': 'Formulario SHOWCURRENT de datos Artículo',
	'text_contenido_titulo_form_articulo_SEARCH': 'Formulario SEARCH de datos Artículo',

	//textos entidad ubicacion
	'text_titulo_page_ubicacion' : 'Gestión de datos Ubicación',
	'text_contenido_titulo_form_ubicacion_ADD': 'Formulario ADD de datos Ubicación',
	'text_contenido_titulo_form_ubicacion_EDIT': 'Formulario EDIT de datos Ubicación',
	'text_contenido_titulo_form_ubicacion_DELETE': 'Formulario DELETE de datos Ubicación',
	'text_contenido_titulo_form_ubicacion_SHOWCURRENT': 'Formulario SHOWCURRENT de datos Ubicación',
	'text_contenido_titulo_form_ubicacion_SEARCH': 'Formulario SEARCH de datos Ubicación',
    ...
    'alumnograduacion_telefono': 'Teléfno',
    'alumnograduacion_email': 'Email',
    'alumnograduacion_fotoacto': 'Foto Acto',
	'nuevo_alumnograduacion_fotoacto': 'Nuevo Foto Acto',
	'CodigoA': 'Código del artículo',
	'AutoresA': 'Autores del artículo',
	'TituloA': 'Título del artículo',
	'TituloR': 'Título de la revista',
	'ISSN': 'ISSN',
	'VolumenR': 'Volumen de la revista',
	'PagIniA': 'Página inicial del artículo',
	'PagFinA': 'Página final del artículo',
	'FechaPubblicacionR': 'Fecha de publicación de la revista',
	'FicheropdfA': 'Fichero pdf del artículo',
	'nuevo_FicheropdfA': 'Nuevo fichero pdf del artículo',
	'EstadoA': 'Estado del artículo',
	'opcion_enviado': 'Enviado',
	'opcion_revision': 'Revisión',
	'opcion_publicado': 'Publicado',
	'id_site': 'ID',
	...
	'label_nuevo_alumnograduacion_fotoacto': 'Nuevo Foto Acto',
	'label_CodigoA': 'Código del artículo',
	'label_AutoresA': 'Autores del artículo',
	'label_TituloA': 'Título del artículo',
	'label_TituloR': 'Título de la revista',
	'label_ISSN': 'ISSN',
	'label_VolumenR': 'Volumen de la revista',
	'label_PagIniA': 'Página inicial del artículo',
	'label_PagFinA': 'Página final del artículo',
	'label_FechaPubblicacionR': 'Fecha de publicación de la revista',
	...
	'alumnograduacion_login_min_size_KO':'Login demasiado corto. Debe tener más de 4 caracteres alfanuméricos',
	'alumnograduacion_login_max_size_KO':'Login demasiado largo. Debe tener menos de 15 caracteres alfanuméricos',
	'alumnograduacion_login_format_KO':'Login incorrecto. Solo se permiten caracteres alfanuméricos',

    // alumnograduacion_password
	'alumnograduacion_password_min_size_KO':'Contraseña demasiado corta. Debe tener más de 4 caracteres alfanuméricos',
	'alumnograduacion_password_max_size_KO':'Contraseña demasiado larga. Debe tener menos de 15 caracteres alfanuméricos',
	'alumnograduacion_password_format_KO':'Contraseña incorrecta. Solo se permiten caracteres alfanuméricos',

	//alumnograduacion_titulacion
	'alumnograduacion_titulacion_min_size_KO':'Titulación demasiado corta. Debe tener 3 o más caracteres alfabéticos',
	'alumnograduacion_titulacion_max_size_KO':'Titulación demasiado larga. Debe tener como máximo 4caracteres alfabéticos',
	'alumnograduacion_titulacion_format_KO':'Titulación incorrecta. Solo se permiten GREI, GRIA, MEI, MIA o PCEO',

	// alumnograduacion_dni
	'alumnograduacion_dni_min_size_KO':'Número de identificación demasiado corto. Debe tener 8 números y 1 letra',
	'alumnograduacion_dni_max_size_KO':'Número de identificación demasiado largo. Debe tener 8 números y 1 letra',
	'alumnograduacion_dni_nie_format_KO':'Formato de DNI/NIE incorrecto. DNI: 8 dígitos y 1 letra; NIE: 1 letra, 7 dígitos y 1 letra',

    // nombre_alumnograduacion
	'alumnograduacion_nombre_min_size_KO':'Nombre demasiado corto. Debe tener más de 4 caracteres alfabéticos',
	'alumnograduacion_nombre_max_size_KO':'Nombre demasiado largo. Debe tener menos de 15 caracteres alfabéticos',
	'alumnograduacion_nombre_format_KO':'Nombre incorrecto. Solo se permiten caracteres alfabéticos',

    // alumnograduacion_apellidos
	'alumnograduacion_apellidos_min_size_KO': 'Apellidos demasiado cortos. Deben tener más de 4 caracteres alfabéticos o espacios',
	'alumnograduacion_apellidos_max_size_KO': 'Apellidos demasiado largos. Deben tener menos de 20 caracteres alfabéticos o espacios',
	'alumnograduacion_apellidos_format_KO': 'Apellidos incorrectos. Solo se permiten caracteres alfabéticos y espacios',


	// email alumnograduacion
	'alumnograduacion_email_min_size_KO': 'Email demasiado corto. Introduce una dirección de correo válida',
	'alumnograduacion_email_max_size_KO':'Email demasiado largo. Introduce una dirección de correo válida',
	'alumnograduacion_email_format_KO':'Formato de email incorrecto. Introduce una dirección de correo válida (ej: usuario@dominio.com)',

	//alumnograduacion_telefono
	'alumnograduacion_telefono_min_size_KO':'Número de teléfono demasiado corto. Debe contener 9 números',
	'alumnograduacion_telefono_max_size_KO':'Número de teléfono demasiado largo. Debe contener 9 números',
	'alumnograduacion_telefono_format_KO':'Número de teléfono incorrecto. Debe contener solo números',
	...
	'nuevo_alumnograduacion_fotoacto_not_exists_file_KO':'El fichero no existe. Debe subirse una foto en formato JPG.',
	'nuevo_alumnograduacion_fotoacto_max_size_file_KO':'El fichero es demasiado grande. Tamaño máximo permitido: 2000000B.',
	'nuevo_alumnograduacion_fotoacto_type_file_KO':'Tipo de fichero incorrecto. Solo se permiten imágenes JPG.',
	'nuevo_alumnograduacion_fotoacto_name_format_KO':'Nombre de fichero inválido. Debe tener entre 3 y 20 caracteres alfanuméricos sin espacios.',
	'nuevo_alumnograduacion_fotoacto_name_min_size_KO':'El tamaño del fichero es demasiado pequeño.',
	'nuevo_alumnograduacion_fotoacto_name_max_size_KO':'El tamaño del fichero excede el máximo permitido.',
	...
	//CodigoA
	'CodigoA_min_size_KO': 'El código del artículo debe tener 11 dígitos',
	'CodigoA_max_size_KO' : 'El código del artículo debe tener 11 dígitos',
	'CodigoA_format_KO': 'El código del artículo solo permite dígitos',
	...
	'TituloR_max_size_KO': 'El título de la revista debe tener como mínimo 3 y como máximo 100 caracteres alfabéticos, incluyendo ñ, acentos y espacios',
	'TituloR_format_KO': 'El título de la revista solo permite caracteres alfabéticos, incluyendo ñ, acentos y espacios',

	//ISSN
	'ISSN_format_KO': 'El ISSN debe tener el formato DDDD-DDDD, donde D es un dígito',

	//VolumenR
	'VolumenR_min_size_KO': 'El volumen de la revista debe tener por lo menos un dígito',
	'VolumenR_max_size_KO': 'El volumen de la revista debe tener como máximo 4 dígitos',
	'VolumenR_format_KO': 'El volumen de la revista solo permite dígitos',

	//PagIniA
	'PagIniA_min_size_KO': 'La página inicial del artículo debe tener como mínimo un dígito',
	'PagIniA_max_size_KO': 'La página inicial del artículo debe tener como máximo 4 dígitos',
	'PagIniA_format_KO': 'La página inicial del artículo solo permite dígitos numéricos',

	//PagFinA
	'PagFinA_min_size_KO': 'La página final del artículo debe tener como mínimo un dígito',
	'PagFinA_max_size_KO': 'La página final del artículo debe tener como máximo 4 dígitos',
	'PagFinA_format_KO': 'La página final del artículo solo permite dígitos numéricos',

	//FechaPublicacionR
	'FechaPublicacionR_format_KO': 'La fecha de publicación debe tener el formato dd/mm/aaaa',

	//nuevo_FicheropdfA
	'nuevo_FicheropdfA_not exists_file_KO': 'El fichero del artículo no existe',
	...
	//errores acciones
	'RECORDSET_VACIO' : 'No hay resultados para su búsqueda',
	'alumnograduacion_dni_es_nulo_KO':'El campo DNI no puede estar vacío',

	'admin_no_se_puede_modificar_KO':'El administrador no se puede modificar',
